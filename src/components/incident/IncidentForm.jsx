  ...
  const field = (label, key, type = "text", placeholder = "", required = false) => (
    <div>
      ...
      <input
        ...
        required={required}
        className="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:ring-2 focus:ring-usafa-blue focus:border-usafa-blue outline-none transition"
      />
    </div>
  );
